	...
	return (
		<div>
			<form onSubmit={handleSubmit}>
				<Input {...title} name={'title'} title={'Lets Talk About:'} placeholder={'I would like to talk...'} />
				<TextArea
					{...body}
					title={'Whats Matter:'}
					name={'message'}
				...
				/>
				<Input {...author} name={'author'} title={'Name'} placeholder={'Author Name'} />
				<Button action={handleSubmit} type={'primary'} title={'Submit Post'} />
				<Button action={handleClearForm} type={'secondary'} title={'Clear'} />
			</form>
		</div>
	);
}
