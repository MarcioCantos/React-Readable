				...
				<Fragment>
					<div className="post">
						...
						<div className="post-content">
							<div className="post-header">
								<div className="author-block">
									...
									<span className="post-category" onClick={(e) => toCategory(e, post.category)}>
										{' '}
										{post.category}
									</span>
								</div>
								<div className="post-date">{timeSince(post.timestamp)}</div>
							</div>
						...
						<div className="post-buttons">
							<button className="btn btn-default btn-edit" onClick={() => setModalShow(true)}>
								<FiEdit3 />
							</button>
					...
					{pagePost && <div className="post-body">{post.body}</div>}
				</Fragment>
			)}
		</Fragment>
	);
